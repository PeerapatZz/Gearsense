...
export function DashboardPage() {
  ...
  const categoryData = [
    { name: t('type.phone'), value: 45, color: '#8b5cf6' },
    { name: t('type.laptop'), value: 35, color: '#6366f1' },
    { name: t('type.gaming'), value: 20, color: '#a855f7' },
  ];

  const usageData = [
    { name: t('usage.gaming'), users: 45 },
    { name: t('usage.work'), users: 62 },
    { name: t('usage.general'), users: 38 },
  ];
  ...
  return (
    <div className="min-h-screen pt-24 pb-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          {[
            { label: t('type.phone'), count: 12, icon: Smartphone, trend: '+15%' },
            { label: t('type.laptop'), count: 8, icon: Laptop, trend: '+8%' },
            { label: t('type.gaming'), count: 16, icon: Gamepad2, trend: '+22%' },
          ].map((cat) => {
            const Icon = cat.icon;
            return (
              <div
